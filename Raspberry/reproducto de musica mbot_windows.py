...
carpeta_musica = r"C:\Users\dany7\Music\Top +100 éxitos de Carlos Ramón"
...
class MusicPlayer(QWidget):
    ...
    def initUI(self):
        ...
        self.btn_atras = self.create_button_with_image(r'C:\Users\dany7\Pictures\Nueva carpeta\atras.png')
        self.btn_atras.clicked.connect(self.retroceder_cancion)
        grid_layout.addWidget(self.btn_atras, 2, 0)

        self.btn_pausa = self.create_button_with_image(r'C:\Users\dany7\Pictures\Nueva carpeta\pausa.png')
        self.btn_pausa.clicked.connect(self.pausar_reproducir)
        grid_layout.addWidget(self.btn_pausa, 2, 1)

        self.btn_siguiente = self.create_button_with_image(r'C:\Users\dany7\Pictures\Nueva carpeta\adelante.png')
        ...
        self.btn_w = self.create_button_with_image(r'C:\Users\dany7\Pictures\Nueva carpeta\w.png')
        self.btn_w.clicked.connect(lambda: self.enviar_motor('A'))
        grid_layout.addWidget(self.btn_w, 0, 7)

        self.btn_a = self.create_button_with_image(r'C:\Users\dany7\Pictures\Nueva carpeta\a.png')
        self.btn_a.clicked.connect(lambda: self.enviar_motor('B'))
        grid_layout.addWidget(self.btn_a, 1, 6)

        self.btn_d = self.create_button_with_image(r'C:\Users\dany7\Pictures\Nueva carpeta\d.png')
        self.btn_d.clicked.connect(lambda: self.enviar_motor('D'))
        grid_layout.addWidget(self.btn_d, 1, 8)

        self.btn_s = self.create_button_with_image(r'C:\Users\dany7\Pictures\Nueva carpeta\s.png')
        self.btn_s.clicked.connect(lambda: self.enviar_motor('C'))
        grid_layout.addWidget(self.btn_s, 2, 7)

        self.btn_panzon = self.create_button_with_image(r'C:\Users\dany7\Pictures\Nueva carpeta\detener.png')
...
if __name__ == '__main__':
    ...
    icon_path = r'C:\Users\dany7\Pictures\Nueva carpeta\00_mbot Mega.png'
