...
class MusicPlayer(QWidget):
    ...
    def initUI(self):
        ...
        self.btn_siguiente = self.create_button_with_image(r'/home/itzel/Imágenes/Nueva carpeta/adelante.png')
        ...
        self.btn_s = self.create_button_with_image(r'/home/itzel/Imágenes/Nueva carpeta/fiesta.png')
        self.btn_s.clicked.connect(lambda: self.enviar_motor('1'))
        self.btn_s.clicked.connect(lambda: self.enviar_cancion_104())
        grid_layout.addWidget(self.btn_s, 2, 8)
    ...
    def enviar_cancion_104(self):
        db.child("test").update({"cancion": "104"})
        self.reproducir_por_indice(104)
        print("Canción 104 enviada a Firebase y reproducida")
